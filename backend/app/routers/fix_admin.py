...
<div class="card"><h2>Order tests</h2><p class="muted">Symbol <span class="pill">USDMXN.r</span> Quantity <span class="pill">1.00</span> Side <span class="pill">BUY</span>. Limit tests use a non-marketable price 0.05 below the current FIX bid.</p><div class="grid">
