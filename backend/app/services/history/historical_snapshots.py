...
def snapshot_to_comparable(snap: ResearchMarketSnapshot) -> dict:
    ...
    return {
        ...
        "context": {
            ...
            "momentum_1h": snap.momentum_1h,
            "momentum_2h": snap.momentum_2h,
            "momentum_4h": snap.momentum_4h,
            "intraday_vol_4h": snap.intraday_vol_4h,
            "intraday_vol_24h": snap.intraday_vol_24h,
            "fed_funds": snap.fed_funds,
            "banxico_rate": snap.banxico_rate,
